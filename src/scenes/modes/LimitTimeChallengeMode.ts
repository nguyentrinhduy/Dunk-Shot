...
export class LimitTimeChallengeMode extends Mode {
    ...
    protected create(): void {
        ...
        this.level = this.dataManager.getChallengeLevel(Challenge.LIMIT_TIME)
        this.loadMap()
        ...
        objectLayer.objects.forEach((object) => {
            switch (object.type) {
                ...
                case 'straight_obstacle': {
                    let obstacle = new StraightObstacle(
                        this.scene,
                        object.x,
                        object.y! - dy,
                        this.ball
                ...
                case 'bouncer': {
                    let obstacle = new BouncerObstacle(
                        this.scene,
                        object.x,
                        object.y! - dy,
                        this.ball
    ...
    public update(time: number, delta: number): void {
        ...
        if (this.baskets.length == 1) {
            ...
            this.dataManager.updateChallengeLevel(Challenge.LIMIT_TIME)
        }
    }
    private createBall() {
