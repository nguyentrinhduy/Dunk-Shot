...
export class MainMenuScene extends Scene {
    ...
    constructor() {
        ...
        // )
        // this.settingsButton = new Button(BUTTONS.SETTINGS.POSITION.X, BUTTONS.SETTINGS.POSITION.Y)
    }
    // create() {
    //     // this.input.once('pointerup', this.onMainScreenClicked)
    //     this.logo = this.add.sprite(ICONS.LOGO.POSITION.X, ICONS.LOGO.POSITION.Y, ICONS.LOGO.KEY)
    ...
    //     )
    //     this.ballSkinsButton.addSprite(
    //         this,
