...
export class PauseUI extends UI {
    ...
    public create(): void {
        ...
        this.resume_button.addText('RESUME', -55, -25, {
            fontSize: '40px',
            fontStyle: 'bold',
            color: 'white',
            fontFamily: 'Triomphe',
        ...
        this.main_menu_button.addText('MAIN MENU', -55, -25, {
            fontSize: '40px',
            fontStyle: 'bold',
            color: 'white',
            fontFamily: 'Triomphe',
        ...
        this.ball_skins_button.addText('CUSTOMIZE', -55, -25, {
            fontSize: '40px',
            fontStyle: 'bold',
            color: 'white',
            fontFamily: 'Triomphe',
