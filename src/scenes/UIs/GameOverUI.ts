...
export class GameOverUI extends UI {
    ...
    public create(): void {
        ...
        const text = this.scene.add.text(WINDOW_SIZE.WIDTH/2, 50, 'BEST RECORD', {fontSize: '50px', color: '#ff7300', fontStyle: 'bold'}).setOrigin(0.5)
        this.bestRecordsText = this.scene.add.text(WINDOW_SIZE.WIDTH/2, 100, '0', {fontSize: '60px', color: '#ff7300', fontStyle: 'bold'}).setOrigin(0.5)
